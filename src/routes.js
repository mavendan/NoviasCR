...
var routes = (
  <Route name="app" path="/" handler={require('./components/app')}>
    ...
    <Route name="galeria" handler={require('./components/galerias/galeriaPage')} />
    <Route name="authors" handler={require('./components/authors/authorPage')} />
    <Route name="courses" handler={require('./components/courses/coursePage')} />
    <Route name="admin" handler={require('./components/admin/galleryAdminPage')} />
    ...
    <Route name="manageGallery" path="pic/:id" handler={require('./components/admin/manageGalleryPage')} />
